...
# tAAE.optimizer_discriminator=Adam(PiecewiseConstantDecay(boundaries = [1000,4000], values = [0.0000001, 0.0001, 0.001]))
tAAE.optimizer_autoencoderr=RMSprop(0.01)
tAAE.gfactor=0.0000001
...
logdir=r"..\data\experiments\temporalAAEv3-rmsprop0.01-large-batch"
