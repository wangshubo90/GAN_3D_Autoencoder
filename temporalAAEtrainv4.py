...
logdir=r"..\data\experiments\temporalAAEv4_morelayers"
...
tAAE.optimizer_autoencoderr=Adam(0.001)
...
summary = tAAE.train(train_set, val_set, 10000, logdir=logdir, logstart=500, logimage=8, slices=[slice(None), 36])
# x, y = next(traingen)
